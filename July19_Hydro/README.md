...
## (5) Run of X-SCAPE 
> In this exercise, we will runs `3DGlauber+iMATTER` or `3DGlauber+iMATTER+MUSIC+iSS` with parameter file `jetscape_user_iMATTERMCGlauberMUSIC.xml` to and produces string files and a particle list. 
